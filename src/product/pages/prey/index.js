        ...
        <div class="col-12">
          <div class="row">
              ...
              <div class="col-12" justify-content="center">
                ...
                >
                  ...
                  <p class="text-justify">
                    ...
                    Comunidade e individualmente :<br />
                    <br />
                    <div>
                      <strong>
                        <p>• Oficio Divino</p>
            ...
            <div class="row mb-3">
              ...
              <div class="col-7">
                <h4>
                  <Divider>Ofício Divino</Divider>
                </h4>
                <p class="text-justify">
                  Para estimular e nutrir essa Presença do Senhor, as Monjas são
                  chamadas ao Louvor ao Criador desde o nascer ao pôr do sol e
                  esta Oração Litúrgica, não o fazem por si mesmas, mas em nome
                  de toda a Igreja e pela humanidade. Por isso, elevam salmos e
                  hinos de louvor e gratidão ao Senhor na Liturgia das Horas, 7
                  vezes durante o dia, comunitariamente. Portanto o Mosteiro é
                  um recanto de Oração, é o Lugar da Casa de Deus e oferece um
                  ambiente propício, para todos os fiéis freqüentadores, que
                  desejam crescer na oração pessoal, na meditação da Palavra e
                  ficar aos pés do Senhor , no Santíssimo Sacramento como
            ...
            <div class="row mb-3">
              ...
              <div class="col-7" justify-content="left">
                <h4>
                  <Divider>Meditação da Palavra</Divider>
                </h4>

                <p class="text-justify">
                  Os Monges e Monjas, desde suas origens, buscam viver este dom
                  da Oração,iluminados pela Luz das Sagradas Escrituras. A
                  meditação assídua da Palavra, é a chave para o aprofundamento
                  e conhecimento do Senhor e da realização de Sua Vontade em
                  nossa vida.Esta meditação a monja aprende a realizar em 4
                  etapas:
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  Oratio: Iluminada pela Palavra, pede a Graça do Senhor para a
                  sua transformação e conversão.
                  <br />
                  <br />
                ...
                <p class="text-justify">
                  <em>
                    <strong>
                      É na Oração e meditação, que a Monja encontra força, para
            ...
            <div class="row mb-3">
              ...
              <div class="col-7" justify-content="left">
                ...
                <p>
                  ...
                  suas orações, seus trabalhos e sofrimentos, são unidos aos de
                  Cristo e à sua Oferenda Total, e adquirem assim um valor novo.
                </p>
                <p>
                  A Consagração da Religiosa ao Senhor é uma oferenda
                  permanente, que diariamente com Jesus, no momento do Santo
                  Sacrifício da Missa, a Monja se oferece com Jesus ao Pai e em
                  uma só oferenda, pela salvação do mundo. As Monjas unidas a
                  Cristo, são como a gota de água que se adiciona ao Cálice com
                  Vinho e se deixam diluir na Essência de Cristo, na Unidade do
                  Espírito Santo e em Louvor ao Pai.
                </p>
                <p>
                  <strong>
            ...
            <div class="row mb-3">
              ...
              <div class="col-7" justify-content="left">
                <h4>
                  <Divider>No Coração da Igreja: Somos Intercessoras</Divider>
                </h4>
                <ShowMoreText
                  lines={15}
                  more={"Mostrar mais"}
